...
class PasswordResetTests(TestCase):
    ...
    def test_form_inputs(self):
        '''
        The view must contain 2 inputs: csrf and email
...
class SuccessfulPasswordResetTests(TestCase):
    ...
    def test_redirection(self):
        ...
        '''
        url = reverse('home:password_reset_done')
...
class PasswordResetConfirmTests(TestCase):
    def setUp(self):
        ...
        url = reverse('home:password_reset_confirm', kwargs={'uidb64': self.uid, 'token': self.token})
...
class InvalidPasswordResetConfirmTests(TestCase):
    def setUp(self):
        ...
        url = reverse('home:password_reset_confirm', kwargs={'uidb64': uid, 'token': token})
        self.response = self.client.get(url)
...
class PasswordResetCompleteTests(TestCase):
    def setUp(self):
        url = reverse('home:password_reset_complete')
        self.response = self.client.get(url)
